    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <header className="bg-white px-6 py-4 flex items-center justify-between border-b border-gray-200">
         <button onClick={() => navigate('/dashboard')} className="flex items-center gap-2 text-slate-500 hover:text-slate-900 font-medium">
           <ArrowLeft size={20} /> <span className="hidden sm:inline">Exit Revision</span>
         </button>
            ...
            <div className="flex-1">
               {step.id === 'notes' && (
                 <div className="prose max-w-none text-slate-600">
                    <ul className="space-y-4 list-disc pl-5">
                       <li><strong>Quadratic Formula:</strong> x = (-b ± √Δ) / 2a</li>
                       <li><strong>Discriminant (Δ):</strong> Determines the nature of roots.</li>
                       <li>If Δ &gt; 0: Two real distinct roots.</li>
                       <li>If Δ = 0: One real repeated root.</li>
                       <li>If Δ &lt; 0: Two complex conjugate roots.</li>
                       <li><strong>Vertex Form:</strong> y = a(x-h)² + k, where (h,k) is the vertex.</li>
                    </ul>
                 </div>
               )}
               ...
               {step.id === 'quiz' && (
                 <div className="space-y-6">
                    <p className="font-medium text-lg text-slate-900">What is the condition for real and equal roots?</p>
