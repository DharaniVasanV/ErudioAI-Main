...
import { Play, BrainCircuit, CalendarClock, Mic, FileText, Check, ArrowLeft, BookCheck } from 'lucide-react';
...
export const TopicDetailPage = () => {
  ...
  const handleScheduleRevision = (dateDesc: string) => {
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm min-h-[400px] p-6">
                ...
                <div>
                  ...
                  <div className="prose prose-slate max-w-none mb-6">
                    <p className="text-slate-700 leading-relaxed">
                      This lesson covers the fundamental concepts of {topic.name}. Understanding these principles is crucial for building a solid foundation in this subject area.
                    </p>
                    <p className="text-slate-700 leading-relaxed">
                      The topic explores key theoretical frameworks and practical applications that will help you solve complex problems and excel in your examinations.
                    </p>
                  </div>
                  ...
                  <div className="bg-indigo-50 border-l-4 border-indigo-500 p-4 rounded-r-lg mb-6">
                    ...
                    <ul className="space-y-2 text-slate-700">
                      <li className="flex items-start gap-2">
                        ...
                        <span>Core principle: Understanding the fundamental formula and its derivation</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-indigo-600 font-bold mt-0.5">•</span>
                        <span>Real-world applications: How this concept is used in practical scenarios</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-indigo-600 font-bold mt-0.5">•</span>
                        <span>Problem-solving techniques: Step-by-step approach to tackle exam questions</span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-indigo-600 font-bold mt-0.5">•</span>
                        <span>Common mistakes: What to avoid and how to ensure accuracy</span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div className="font-mono text-sm bg-white p-3 rounded border border-gray-200 text-slate-700">
                      {topic.subjectId === 'math' && 'Formula: ax² + bx + c = 0'}
                      {topic.subjectId === 'phys' && 'Formula: F = ma (Newton\'s Second Law)'}
                      {topic.subjectId === 'cs' && 'Syntax: int *ptr = &variable;'}
                      {topic.subjectId === 'chem' && 'Equation: PV = nRT'}
                    </div>
                  </div>
                  ...
                  <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                    ...
                    <p className="text-slate-700 mb-3">
                      <strong>Question:</strong> Apply the concept of {topic.name} to solve a typical exam-style problem.
                    </p>
                    <p className="text-slate-700">
                      <strong>Solution:</strong> Step 1: Identify the given values. Step 2: Apply the formula. Step 3: Simplify and calculate the result. Step 4: Verify your answer makes sense in the context of the problem.
                    </p>
                  </div>
                </div>
              </div>
        ...
        {activeTab === 'quiz' && (
           <div className="flex flex-col items-center justify-center h-80 text-center">
              ...
              <p className="text-slate-500 max-w-md mb-6">Take a quick 10-question quiz to assess your understanding of {topic.name}.</p>
              <button 
                onClick={() => navigate('/quiz')}
              ...
              <div>
                ...
                <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
                   ...
                   <div className="p-4 prose prose-sm prose-slate max-w-none">
                      ...
                      <ul className="mt-0">
                        <li>The standard form of a quadratic equation is ax² + bx + c = 0.</li>
                        <li>The discriminant Δ = b² - 4ac determines the nature of the roots.</li>
                        <li>If Δ &gt; 0, there are two distinct real roots.</li>
                        <li>If Δ = 0, there is exactly one real root.</li>
                      </ul>
                      <p className="mb-2 mt-4"><strong>Formulas:</strong></p>
                      <p className="bg-gray-50 p-2 rounded border border-gray-100 font-mono text-xs">x = (-b ± √Δ) / 2a</p>
                   </div>
                </div>
              </div>
